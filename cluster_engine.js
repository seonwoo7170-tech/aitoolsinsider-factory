...
async function run() {
    console.log("🚀 VUE V16.2.3.2 Stable-Module Active...");
    ...
    for (let i = 0; i < 5; i++) {
        const isMain = (i === 4);
        console.log(`📂 Processing Article [${i+1}/5]... (Safe Mode)`);
        ...
        const titleText = await callGemini(model, `SEO Title for "${targetTopic}" (Style: ${activePersona}). Lang: ${lang}. NO Quotes.`);
